...
amount = f"{2000:015d}"  # yields "000000000004000"
...
recipient_name = hub3_field("MACAKLIN", 25)
...
iban = "HR8923600001103161823"  # must be 21 characters
